...
<div class="center section" id="ocultar">
...
<!-- para ocultar/mostar el contenido por el preloader-->
<div class="hide" id="mostrar">
    
<!-- Logo del pnp al inicio -->
<img src="media/images/PNP4.png">
...
<script>
    window.addEventListener('load' () => {
        ...
        document.getElementById('ocultar').className = 'hide';
        }
